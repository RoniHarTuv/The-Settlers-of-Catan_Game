...
or a town can be established on a junction.
...
Junction *Board::getJunctionAt(int index) { return this->_junctions[index]; }
// this function return way* of speceifed index
Way *Board::getWayAt(int index) { return this->_ways[index]; }
// this function return land* of speceifed index
Land *Board::getLandAt(int index) { return this->_lands[index]; }
...
{
  for(int i=0; i<54;i++){
    this->_junctions[i]->printJunction();
  }
}
...
Board::Board() {
  ...
  Land *pl1 =
      new Land(forest, 1, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l2(sheeps, 2, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl2 =
      new Land(sheeps, 2, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l3(agricultural, 3, vector<Town>(), vector<Road>(),
          vector<Settelment>());
  Land *pl3 = new Land(agricultural, 3, vector<Town>(), vector<Road>(),
                       vector<Settelment>());
  Land l4(hills, 4, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl4 =
      new Land(hills, 4, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l5(mountains, 5, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl5 = new Land(mountains, 5, vector<Town>(), vector<Road>(),
                       vector<Settelment>());
  Land l6(hills, 6, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl6 =
      new Land(hills, 6, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l7(sheeps, 7, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl7 =
      new Land(sheeps, 7, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l8(dessert, 8, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl8 = new Land(dessert, 8, vector<Town>(), vector<Road>(),
                       vector<Settelment>());
  Land l9(forest, 9, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl9 =
      new Land(forest, 9, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l10(agricultural, 10, vector<Town>(), vector<Road>(),
           vector<Settelment>());
  Land *pl10 = new Land(agricultural, 10, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l11(forest, 11, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl11 = new Land(forest, 11, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l12(agricultural, 12, vector<Town>(), vector<Road>(),
           vector<Settelment>());
  Land *pl12 = new Land(agricultural, 12, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l13(hills, 13, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl13 =
      new Land(hills, 13, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land l14(sheeps, 14, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl14 = new Land(sheeps, 14, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l15(sheeps, 15, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl15 = new Land(sheeps, 15, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l16(mountains, 16, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl16 = new Land(mountains, 16, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l17(mountains, 17, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl17 = new Land(mountains, 17, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l18(agricultural, 18, vector<Town>(), vector<Road>(),
           vector<Settelment>());
  Land *pl18 = new Land(agricultural, 18, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
  Land l19(forest, 19, vector<Town>(), vector<Road>(), vector<Settelment>());
  Land *pl19 = new Land(forest, 19, vector<Town>(), vector<Road>(),
                        vector<Settelment>());
