...
namespace catan {
     ...
     * Each land has a resource type, a unique number, and a land number from 2 to 12. It can also hold roads, junctions, and a card representing a resource.
     */
    class Land {
    private:
        ...
        Card* _card=nullptr; ///< Pointer to a Card representing the resource //&&&&&nullptr
        vector<Junction*> _junctions={3,nullptr}; ///< Junctions located on the vertices of the land//$$$$null
