...
namespace catan
{
    ...
    private:
        ...
        Town *_town= nullptr;                     // Pointer to a Town
        Settelment *_settelment=nullptr;          // Pointer to a Settlement
        bool _is_occupate=false  ;                // Occupied status of the junction//$$$ flse
        vector<Way *> _ways = {3, nullptr};       // Vector of Way pointers (initialized to hold 3 nullptr elements)
        vector<Land *> _lands = {3, nullptr};     // Vector of Land pointers (initialized to hold 3 nullptr elements)
