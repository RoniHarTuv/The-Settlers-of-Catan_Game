...
using namespace catan;
    ...
    BrickCard::BrickCard()
    {
        this->_type = "BrickCard";
    }

    // Override getType method for BrickCard
    string BrickCard::getType() const
    {
        return this->_type;
    }
