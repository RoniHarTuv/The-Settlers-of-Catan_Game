...
using namespace catan;
    ...
    int monopolDCard::getQuantity() const {
        return 100;
    }

    // Clones the monopolDCard.
    DevelopmentCard* monopolDCard::clone() const {
        return new monopolDCard(*this);
    }

    // Returns the type of monopolDCard.
    string monopolDCard::getType() const {
        return "monopol card";
    }
    ...
    int BonusPointDCard::getQuantity() const {
        return 4;
    }
    ...
    string BonusPointDCard::getType() const {
        return "bonus point card";
    }
    ...
    int YearOfPlentyDCard::getQuantity() const {
        return 100;
    }
    ...
    string YearOfPlentyDCard::getType() const {
    ...
    int RoadDCard::getQuantity() const {
        return 100;
    }

    // Clones the RoadDCard.
    DevelopmentCard* RoadDCard::clone() const {
        return new RoadDCard(*this);
    }

    // Returns the type of RoadDCard.
    string RoadDCard::getType() const {
        return "road card";
    }
    ...
    int KnightDCard::getQuantity() const {
        return 3;
    }

    // Clones the KnightDCard.
    DevelopmentCard* KnightDCard::clone() const {
        return new KnightDCard(*this);
    }

    // Returns the type of KnightDCard.
    string KnightDCard::getType() const {
        return "knight card";
    }
