...
namespace catan
{
     ...
     * 
     * Each player has a name, a collection of cards, points, and a flag indicating if it is their turn. 
     * They are also associated with a game board and can perform various actions such as buying and using development cards, placing roads, settlements, and towns, rolling dice, and trading with other players.
     */
    class Player
    {
    private:
