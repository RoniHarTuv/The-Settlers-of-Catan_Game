...
namespace catan
{
    ...
    /**
     * class Asset:
     * This class stands for "game tool". From this class, three classes inherit: Road, Settelment, and Town.
     * This class is virtual, meaning that no object is created from it, but only from the classes that inherit from it.
     * Each class has a "Player" field that refers to the owner of that object.
     */
    class Asset
    {
    public:
    ...
    {
    public:
        Settelment(Player *p); // Constructor for Settelment that sets the owner player.
