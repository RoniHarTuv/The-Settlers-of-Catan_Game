...
Road::Road(Player *p) { this->_player = p; }

// Get the player who owns the road.
Player *Road::getPlayer() { return this->_player; }

// Get the type of the asset.
string Road::getType() { return "Road"; }

// Constructor for Town that sets the owner player.
Town::Town(Player *p) { this->_player = p; }
...
// Get the type of the asset.
string Town::getType() { return "Town"; }

// Get the player who owns the town.
Player *Town::getPlayer() { return this->_player; }

// Constructor for Settelment that sets the owner player.
Settelment::Settelment(Player *p) { this->_player = p; }
...
// Get the type of the asset.
string Settelment::getType() { return "Settelment"; }
